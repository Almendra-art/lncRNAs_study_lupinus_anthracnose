...
#Previously, a new_annotation.gtf file was constructed including annotated genes in the reference genome with "Llu" prefix, and the identifier of unannotated genes predicted as lncRNAs was changed with the "Llu_lncRNA" prefix. No identified genes in the genome and not predicted as lncRNAs, were identified with prefix "MSTRG".
